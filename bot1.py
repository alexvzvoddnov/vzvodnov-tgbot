...
async def start_handler(message: Message):
    await message.answer("Привет! Я AI-бот на основе GPT. Задай мне любой вопрос! 💬")

# /help
@dp.message(Command("help"))
async def help_handler(message: Message):
    await message.answer("Просто напиши любой текст — и я постараюсь дать развернутый ответ!")
